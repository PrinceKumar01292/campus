...
import { UnsPlashImagePicker } from '@/components/unplash-image-picker';
import { Label } from "@/components/ui/label";
import { Badge } from '@/components/ui/badge';
import { CalculatorIcon, Crown, Loader2, Sparkles } from 'lucide-react';
...
const eventSchema =z.object({
    ...
    description: z
        .string()
        .min(20, "Description must be at least 20 chareter long"),
...
const CreateEvent = () => {
  ...
  const indianStates = State.getStatesOfCountry("IN");
    ...
    const handleColorClick = (color) => {
        // if not default color and user doesn't has pro
   ...
   const onSubmit = async (data) => {
    try {
        ...
        // This makes it properly async - returns the promise from createEvent
        await createEvent({
            title: data.title,
    ...
    const handleAIGenerate =(generatedData) => {
        ...
        toast.success("Event detail failled ! customize as needed.");
             ...
             <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                        ...
                        <Popover>
                            <PopoverTrigger asChild>
                                ...
                                >
                                    ...
                                    <CalculatorIcon className="w-4 h-4 opacity-60" />
                ...
                <div className="space-y-2">
                    ...
                    <div className="space-y-2 mt-6">
                        <Input
                        {...register("venue")}
                        placeholder="Venu link (Google Maps Link)"
                        type="url"
                        />
