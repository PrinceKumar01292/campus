    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Descibe your event idea and let AI create the details for you
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4">
            <Textarea
                ...
                placeholder="Exeample: A tech meetup about React 19 for developer in Bhopal. It should
                cover new feature like action and use hook improvements..."
