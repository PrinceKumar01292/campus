...
const DynamicExplorePage = () => {
  ...
  // if it is not a valid category and not valid location  show 404
     ...
     <>
          <div className="pb-5">
            <div className=" flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-5xl md:text-6xl font-bold"> Event in {city}</h1>
